...
- April 17, 2026: en `/solicitudes/:solicitudId` (vista ESTUDIANTE) el detalle ahora también consulta y muestra **Documentos adjuntos** con el mismo servicio del detalle de coordinación (`GET /sapp/document?tramiteId={id}&codigoTipoTramite={tipoTramiteCodigo}`), y el editor de documentos dejó el mock local para usar checklist real + reemplazo de archivos con `POST /sapp/document`.
