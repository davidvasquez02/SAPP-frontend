...
- **2026-09-03:** la conversión de documentos HTML persistidos a PDF dejó de usar por completo SVG `foreignObject`, pues algunos navegadores contaminan el canvas por el propio `foreignObject` aunque sus imágenes sean locales. El frontend usa el layout calculado por el iframe y pinta fondos, bordes, texto y firmas `data:` directamente en cada página; así **Ver** y **Descargar** pueden exportar sin modificar el HTML guardado.
