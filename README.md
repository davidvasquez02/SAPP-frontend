...
- **2026-09-04:** la marca visible del sistema cambió de **SAPP** a **Minerva**, sin modificar rutas, contratos, claves de storage ni identificadores técnicos existentes. En el sidebar contraído se presenta una marca compacta **M** y, al expandirlo o navegar en móvil, aparece el nombre completo **Minerva**; el título del documento y los textos visibles de usuario también adoptaron la nueva marca.
