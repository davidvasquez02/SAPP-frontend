...
2. Confirmar los campos definitivos de estudiante/coordinación en el DTO de login y retirar fallbacks provisionales.
...
- `npm run build` (2026-09-02): PASS; 237 módulos, assets `index-ZvyW5o5r.css` y `index-CH3D_fKz.js`, 878 ms.
- `npx eslint src/components/ModuleLayout/ModuleLayout.tsx src/app/routes/index.tsx src/pages/index.ts src/pages/Perfil src/modules/perfil` (2026-09-02): PASS; solo warning npm conocido `Unknown env config "http-proxy"`.
